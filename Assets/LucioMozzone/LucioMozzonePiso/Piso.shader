...
Shader "Piso"
{
	...
	SubShader
	{
		...
		{
			float2 uv_TexCoord34 = v.texcoord.xy * float2( 15,15 );
		...
		{
			float2 uv_TexCoord34 = i.uv_texcoord * float2( 15,15 );
			float2 UV35 = uv_TexCoord34;
...
/*ASEBEGIN
Version=18900
0;630;1464;361;6356.914;879.1898;5.320341;True;False
Node;AmplifyShaderEditor.CommentaryNode;39;-2234.723,-842.6047;Inherit;False;553.226;216.8073;Comment;2;34;35;UV;1,1,1,1;0;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;34;-2184.723,-784.7974;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;15,15;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=CA39619253B595C140EF52F47151736AA6B7FD01