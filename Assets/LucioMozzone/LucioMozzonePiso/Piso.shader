...
Shader "Piso"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 uv_TexCoord43 = i.uv_texcoord * ( float2( 0,0 ) / float2( 0,0 ) );
			float4 _Vector2 = float4(3,3,1,1);
			float2 appendResult46 = (float2(_Vector2.x , _Vector2.y));
			float2 appendResult47 = (float2(_Vector2.z , _Vector2.w));
			float2 ScaleAndOffset48 = (uv_TexCoord43*appendResult46 + appendResult47);
			float2 uv_TextureSample2 = i.uv_texcoord * _TextureSample2_ST.xy + _TextureSample2_ST.zw;
			float Scale53 = _Float0;
			float3 ase_worldPos = i.worldPos;
			float3 ase_worldViewDir = normalize( UnityWorldSpaceViewDir( ase_worldPos ) );
			float3 View55 = ase_worldViewDir;
			float2 Offset49 = ( ( tex2D( _TextureSample2, uv_TextureSample2 ).r - 1 ) * View55.xy * Scale53 ) + ScaleAndOffset48;
			float2 Offset56 = ( ( tex2D( _TextureSample3, Offset49 ).r - 1 ) * View55.xy * Scale53 ) + Offset49;
			float2 Offset60 = ( ( tex2D( _TextureSample4, Offset56 ).r - 1 ) * View55.xy * Scale53 ) + Offset56;
			float2 Offset64 = ( ( tex2D( _TextureSample5, Offset60 ).r - 1 ) * View55.xy * Scale53 ) + Offset60;
			float4 ParallaxMapping71 = ( _Color0 * tex2D( _TextureSample6, Offset64 ) );
			o.Albedo = ParallaxMapping71.rgb;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18900
0;480;1464;511;4915.516;826.8037;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;72;-8032.57,-712.8079;Inherit;False;4601.471;977.4993;Comment;30;41;42;43;44;45;48;50;54;53;51;46;47;55;49;58;57;59;61;62;63;56;60;65;66;67;64;68;71;73;74;Parallax Mapping;1,1,1,1;0;0
Node;AmplifyShaderEditor.Vector2Node;41;-7982.57,-417.3418;Inherit;False;Constant;_Vector1;Vector 1;6;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleDivideOpNode;42;-7775.487,-412.6097;Inherit;False;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;54;-7189.389,76.69145;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;51;-7314.427,-53.88812;Float;False;Property;_Float0;Float 0;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;50;-7200.027,-256.588;Inherit;True;Property;_TextureSample2;Texture Sample 2;6;0;Create;True;0;0;0;False;0;False;-1;6d3afb4bf8648164d8b214139ceea8f9;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;40;-2201.138,-799.056;Inherit;False;Property;_Tilling;Tilling;5;0;Create;True;0;0;0;False;0;False;0,0;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;62;-5777.809,-282.7325;Inherit;True;Property;_TextureSample4;Texture Sample 4;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;66;-5107.457,-265.1209;Inherit;True;Property;_TextureSample5;Texture Sample 5;10;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.TexturePropertyNode;9;-2177.601,500.2642;Inherit;True;Property;_HeightMap;HeightMap;0;0;Create;True;0;0;0;False;0;False;None;9789d23040cb1fb45ad60392430c3c15;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.ColorNode;73;-4241.885,-644.6667;Float;False;Property;_Color0;Color 0;12;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;17;-2109.451,80.18752;Inherit;True;Property;_NormalMap;NormalMap;3;0;Create;True;0;0;0;False;0;False;None;662d72b6ec210cf4cbeec2b4d3cb8b2a;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;12;-1569.692,930.0876;Inherit;False;Property;_MaxHeight;MaxHeight;4;0;Create;True;0;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;74;-3879.105,-472.147;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;71;-3698.926,-455.5349;Inherit;False;ParallaxMapping;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;22;-231.6628,-43.6159;Inherit;False;71;ParallaxMapping;1;0;OBJECT;;False;1;COLOR;0
...
ASEEND*/
//CHKSM=4533E771F81727734F226E149D44FFFF78D97C8C